...
export function PropertyGallery({ listing }: { listing: Listing }) {
  ...
  if (images.length === 0) {
    return (
      <div className="paper flex items-center justify-center tracker-muted" style={{ height: "clamp(180px, 38vw, 500px)" }}>
  ...
  return (
    <div>
      <div className="flex gap-2" style={{ height: "clamp(180px, 38vw, 500px)" }}>
